...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: In PersonQueue I changed Enqueue to adding to the end instead of the beginning 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: no catch for if turn is 0 or negative, resulting in high negative number.
